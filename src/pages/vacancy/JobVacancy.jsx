...
export default function JobVacancy() {
  ...
  const lowonganFullTime = jobVacancy.filter((_item, index) =>
    [
      ...
      193, 194, 195, 196, 197, 198, 201, 202, 203, 204, 205, 208, 209, 210, 211,
      212, 213, 214, 215, 216, 217, 218, 219, 220, 226, 227, 228, 229,
    ].includes(index)
  );
  ...
  const lowonganInternship = jobVacancy.filter((_item, index) =>
    [
      13, 14, 15, 19, 97, 109, 110, 124, 131, 206, 207, 221, 222, 223, 224, 225,
    ].includes(index)
  );
