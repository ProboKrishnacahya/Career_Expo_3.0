...
export default function BMWAstra() {
  useEffect(() => {
    // * Tab Page Title
    document.title = "BMW Astra";
  ...
  return (
    <div>
      ...
      <div
        ...
        id="jobModal129"
        tabindex="-1"
        aria-labelledby="jobModal129Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal129Label">
                Persyaratan
              </h2>
              <button
                type="button"
            ...
            <div className="modal-body">{persyaratan[129]}</div>
          </div>
        </div>
      </div>
      <div
        ...
        id="jobModal130"
        tabindex="-1"
        aria-labelledby="jobModal130Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal130Label">
                Persyaratan
              </h2>
              <button
                type="button"
            ...
            <div className="modal-body">{persyaratan[130]}</div>
          </div>
        </div>
      </div>
      <div
        ...
        id="jobModal131"
        tabindex="-1"
        aria-labelledby="jobModal131Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal131Label">
                Persyaratan
              </h2>
              <button
                type="button"
            ...
            <div className="modal-body">{persyaratan[131]}</div>
          </div>
        </div>
      </div>
