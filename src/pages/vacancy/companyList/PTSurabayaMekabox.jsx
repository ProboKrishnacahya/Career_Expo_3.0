...
export default function PTSurabayaMekabox() {
  useEffect(() => {
    // * Tab Page Title
    document.title = "PT Surabaya Mekabox";
  ...
  return (
    <div>
      ...
      <div
        ...
        id="jobModal125"
        tabindex="-1"
        aria-labelledby="jobModal125Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal125Label">
                Persyaratan
              </h2>
              <button
                type="button"
            ...
            <div className="modal-body">{persyaratan[125]}</div>
          </div>
        </div>
      </div>
      <div
        ...
        id="jobModal126"
        tabindex="-1"
        aria-labelledby="jobModal126Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal126Label">
                Persyaratan
              </h2>
              <button
                type="button"
            ...
            <div className="modal-body">{persyaratan[126]}</div>
          </div>
        </div>
      </div>
      <div
        ...
        id="jobModal127"
        tabindex="-1"
        aria-labelledby="jobModal127Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal127Label">
                Persyaratan
              </h2>
              <button
                type="button"
            ...
            <div className="modal-body">{persyaratan[127]}</div>
          </div>
        </div>
      </div>
      <div
        ...
        id="jobModal128"
        tabindex="-1"
        aria-labelledby="jobModal128Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal128Label">
                Persyaratan
              </h2>
              <button
                type="button"
            ...
            <div className="modal-body">{persyaratan[128]}</div>
          </div>
        </div>
      </div>
