...
export default function PTSuryaTimurSaktiJatim() {
  useEffect(() => {
    // * Tab Page Title
    document.title = "PT Surya Timur Sakti Jatim";
  ...
  return (
    <div>
      ...
      <div
        ...
        id="jobModal75"
        tabindex="-1"
        aria-labelledby="jobModal75Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal75Label">
                Persyaratan
              </h2>
              <button
                type="button"
      ...
      <div
        ...
        id="jobModal76"
        tabindex="-1"
        aria-labelledby="jobModal76Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal76Label">
                Persyaratan
              </h2>
              <button
                type="button"
      ...
      <div
        ...
        id="jobModal77"
        tabindex="-1"
        aria-labelledby="jobModal77Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal77Label">
                Persyaratan
              </h2>
              <button
                type="button"
      ...
      <div
        ...
        id="jobModal78"
        tabindex="-1"
        aria-labelledby="jobModal78Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal78Label">
                Persyaratan
              </h2>
              <button
                type="button"
      ...
      <div
        ...
        id="jobModal79"
        tabindex="-1"
        aria-labelledby="jobModal79Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal79Label">
                Persyaratan
              </h2>
              <button
                type="button"
      ...
      <div
        ...
        id="jobModal80"
        tabindex="-1"
        aria-labelledby="jobModal80Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal80Label">
                Persyaratan
              </h2>
              <button
                type="button"
      ...
      <div
        ...
        id="jobModal81"
        tabindex="-1"
        aria-labelledby="jobModal81Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal81Label">
                Persyaratan
              </h2>
              <button
                type="button"
      ...
      <div
        ...
        id="jobModal82"
        tabindex="-1"
        aria-labelledby="jobModal82Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal82Label">
                Persyaratan
              </h2>
              <button
                type="button"
      ...
      <div
        ...
        id="jobModal83"
        tabindex="-1"
        aria-labelledby="jobModal83Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal83Label">
                Persyaratan
              </h2>
              <button
                type="button"
