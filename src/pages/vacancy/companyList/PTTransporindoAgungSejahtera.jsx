...
export default function PTTransporindoAgungSejahtera() {
  useEffect(() => {
    // * Tab Page Title
    document.title = "PT Transporindo Agung Sejahtera";
  ...
  return (
    <div>
      ...
      <div
        ...
        id="jobModal123"
        tabindex="-1"
        aria-labelledby="jobModal123Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal123Label">
                Persyaratan
              </h2>
              <button
                type="button"
      ...
      <div
        ...
        id="jobModal124"
        tabindex="-1"
        aria-labelledby="jobModal124Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal124Label">
                Persyaratan
              </h2>
              <button
                type="button"
            ...
            <div className="modal-body">{persyaratan[124]}</div>
          </div>
        </div>
      </div>
