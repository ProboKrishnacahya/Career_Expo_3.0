...
export default function SPSCorporate() {
  useEffect(() => {
    // * Tab Page Title
    document.title = "SPS Corporate";
  ...
  return (
    <div>
      ...
      <div
        ...
        id="jobModal98"
        tabindex="-1"
        aria-labelledby="jobModal98Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal98Label">
                Persyaratan
              </h2>
              <button
                type="button"
            ...
            <div className="modal-body">{persyaratan[98]}</div>
          </div>
        </div>
      </div>
      <div
        ...
        id="jobModal99"
        tabindex="-1"
        aria-labelledby="jobModal99Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal99Label">
                Persyaratan
              </h2>
              <button
                type="button"
