...
export default function WinstonCitraland() {
  useEffect(() => {
    // * Tab Page Title
    document.title = "Winston Citraland";
  ...
  return (
    <div>
      ...
      <div
        ...
        id="jobModal199"
        tabindex="-1"
        aria-labelledby="jobModal199Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal199Label">
                Persyaratan
              </h2>
              <button
                type="button"
            ...
            <div className="modal-body">{persyaratan[199]}</div>
          </div>
        </div>
      </div>
      <div
        ...
        id="jobModal200"
        tabindex="-1"
        aria-labelledby="jobModal200Label"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title text-center" id="jobModal200Label">
                Persyaratan
              </h2>
              <button
                type="button"
            ...
            <div className="modal-body">{persyaratan[200]}</div>
          </div>
        </div>
      </div>
